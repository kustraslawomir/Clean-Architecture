...
class GetObservedCurrencies(private val repository: Repository,
                            postExecutionThread: PostExecutionThread)
    : ObservableUseCase<List<Coin>, Nothing>(postExecutionThread) {

    override fun getObservableUseCase(params: Nothing?): Observable<List<Coin>> = repository.getObservedCurrencies()
